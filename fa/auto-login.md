...
در حال حاضر سرویس اتولاگین در وب‌سرویس بازار‌پی قابل دسترس است. این سرویس با استفاده از کوئری پارام، توکن احراز هویت کاربر را دریافت کرده و فرآیند مورد نظر را با استفاده از آن توکن احراز هویت انجام می‌دهد.

### استفاده از web-sdk بازار‌پی
این روش در حال پیاده‌سازی می‌باشد و بزودی در دسترس قرار می‌گیرد.

### فراخوانی مستقیم وب‌سرویس
در هر انتری پوینت از وب‌سرویس با پاس دادن کوئری پارام `auto_login_token`، وب‌سرویس روش احراز هویت را اتولاگین تشخیص داده و تا انتهای فرآیند مورد نظرِ کاربر، با آن توکن احراز خواهد شد.
...
در حالت عادی هر انتری پوینت تعدادی کوئری پارامز دارد که در هر قسمت به تفصیل در مستندات توضیح داده شده است. برای استفاده از سرویس اتولاگین در این سرویس‌ها، می‌بایست علاوه بر کوئری پارامز سرویس، کوئری `auto_login_token` را هم به سرویس پاس دهید و باقی فرآیند را وب‌سرویس انجام خواهد داد.
